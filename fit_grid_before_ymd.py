...
if __name__ == '__main__':
    ...
    file_name_prefix = clf_kind + '_over' + str(payout) + '_' + str(race_cnt) + '_before' + ymd + prefix_last
    ...
    train_race_keys = ht_util.get_race_keys_except_debut_quinella(payout, ymd, race_cnt)
    ...
    t_util.train_grid(train_race_keys, clf_pkl, sc_pkl, order_limit)
