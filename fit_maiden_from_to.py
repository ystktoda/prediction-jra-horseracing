...
if __name__ == '__main__':
    ...
    file_name_prefix = 'maiden_' + clf_kind + '_over' + str(payout) + '_from' + from_ymd + '_to' + to_ymd + prefix_last
    ...
    train_race_keys = ht_util.get_race_keys_debut_quinella_from_to(payout, from_ymd, to_ymd)
